...
namespace Entidades
{
    public class E_Cierre_Ciclo
    {
        #region Atributos
        private string _Cuenta;
        private string _Servicio_TV;
        private string _Servicio_Internet;
        ...
        private int _Servicio_34;
        private int _Servicio_35;
        private int _Servicio_36;
        ...
        #endregion
        #region Constructor
        public E_Cierre_Ciclo() { 
            _Cuenta = string.Empty;
            _Servicio_TV = string.Empty;
            _Servicio_Internet = string.Empty;
        ...
        public string Servicio_Internet
        {
            get
            {
                return _Servicio_Internet;
            }

            set
            {
                _Servicio_Internet = value;
            }
        }
        ...
        public string Elegido_Fijo_Movil
        {
            get
            {
                return _Elegido_Fijo_Movil;
            }

            set
            {
                _Elegido_Fijo_Movil = value;
            }
        }
        ...
        public string Blindaje_Internet
        {
            get
            {
                return _Blindaje_Internet;
            }

            set
            {
                _Blindaje_Internet = value;
            }
        }
        ...
        public string Activacion_ClaroVideo
        {
            get
            {
                return _Activacion_ClaroVideo;
            }

            set
            {
                _Activacion_ClaroVideo = value;
            }
        }
