<%@ Page Title="" Language="C#" MasterPageFile="~/Perfil_Celula.master" AutoEventWireup="true" CodeFile="Manual_de_Usuario_Celula.aspx.cs" Inherits="Manual_de_Usuario_Celula" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="container"><div style="text-align: left; border: none;">    
<object type="application/pdf" data="Doc/Manual_Celula.pdf" width="100%" height="600" id="pdf"> 
