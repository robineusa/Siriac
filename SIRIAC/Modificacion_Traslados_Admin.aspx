<%@ Page Title="" Language="C#" MasterPageFile="~/Perfil_Administrador.master" AutoEventWireup="true" CodeFile="Modificacion_Traslados_Admin.aspx.cs" Inherits="Modificacion_Traslados_Admin" %>
            ...
            <div id="html-tab" class="tab-content active">
                ...
                <asp:Panel CssClass="panel_informativo" ID="Panel3" runat="server" GroupingText="Detalle del Escalamiento">
                    <table class="tabla">
                        <tr>
                            <td>
                                <asp:Label CssClass="texto_informativo" ID="Label1" runat="server" Text="Id de Traslado"></asp:Label><br />
                            ...
                            <td>
                                <asp:Label CssClass="texto_informativo" ID="Label3" runat="server" Text="Estado del caso"></asp:Label><br />
                                <asp:TextBox CssClass="caja_de_texto" ID="Ticket" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label CssClass="texto_informativo" ID="Label4" runat="server" Text="Fecha de Apertura"></asp:Label><br />
                                <asp:TextBox CssClass="caja_de_texto" ID="Marcacion" runat="server" Enabled="false"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label CssClass="texto_informativo" ID="Label5" runat="server" Text="Hora de Apertura"></asp:Label><br />
                            ...
                            <asp:TextBox CssClass="caja_de_texto" ID="Razon" runat="server" Enabled="false" Style="display: none;"></asp:TextBox>
                            <asp:TextBox CssClass="caja_de_texto" ID="Subrazon" runat="server" Enabled="false" Style="display: none;"></asp:TextBox>
                        </tr>
                    </table>
