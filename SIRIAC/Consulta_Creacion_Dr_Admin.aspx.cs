...
public partial class Consulta_Creacion_Dr_Admin : System.Web.UI.Page
{
    ...
    protected void Consulta_Cierre_Ciclo_LOG(object sender, EventArgs e)
    {
        ...
        ds = Obj_Negocio_Traslados.Consulta_Admin_Solicitudes_Crear_Direccion(Obj_Entidad_Traslados.Fecha_Inicial, Obj_Entidad_Traslados.Fecha_Final);
    ...
    protected void Exportar_Convenio_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment; filename=Base_Solicitudes_Creacion_Direccion-" + DateTime.Now.ToShortDateString() + ".xls");
